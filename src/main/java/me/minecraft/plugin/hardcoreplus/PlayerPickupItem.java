...
public class PlayerPickupItem implements Listener {
    ...
    @EventHandler // Pickup Event
    public void onPlayerPickUp(EntityPickupItemEvent event) {
        // PlayerPickupItemEvent is now deprecated, so I replaced it with EntityPickupItemEvent where Entity is the Player.
        // Sound effects for this class have been temporarily removed because it's not supported for entities.
        ...
        if (entity instanceof Player) { // Check if the entity is player
            if (itemType == Material.WITHER_SKELETON_SKULL) {
                // If WITHER SKELETON SKULL is picked up, player will get:
                // BLINDNESS and WITHER effect for 4 seconds.
